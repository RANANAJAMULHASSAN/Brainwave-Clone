...
function HeroSection() {
    ...
    return (
      <Section
        className="Animation pt-48 -mt-20"
        crosses
      ...
      >
        <div className="container relative" ref={parallaxRef}>
          <div className="relative z-1 max-w-5xl mx-auto text-center mb-15 md:mb-20 lg:mb-28">
            ...
            <Button href="/pricing" className={"border rounded-md"}>
              Get started
            </Button>
          </div>
